...
def main():
    ...
    contacts = Contacts(assembly = args.assembly,
    ...
    contacts.write_contacts_to_file(outfile = args.raw_contacts,
                                    fmt = "%1u")
    ...
    contacts.write_contacts_to_file(outfile = args.output,
                                    fmt = "%1f")

def parse_arguments():
    parser = argparse.ArgumentParser(
        description = 'Generates an ICEd matrix of intrachromosomal contacts ' + 
                      'from a cluster file.')
    ...
    parser.add_argument('-o', '--output',
                        metavar = "FILE",
                        action = "store",
                        help = "The output ICEd contacts file.")
